...
DATASET_INFO = {
    ...
    'vlm_sft': {
        'llava_ov': {
			'data_dir': '/data1/chenyifeng/LM-skills/Post-training/Bagel/data/bagel_example/vlm/images',
			'jsonl_path': '/data1/chenyifeng/LM-skills/Post-training/Bagel/data/bagel_example/vlm/llava_ov_si.jsonl',
			'num_total_samples': 1000
		},
    },
}